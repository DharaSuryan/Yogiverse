...
const InstagramCommentModal: React.FC<InstagramCommentModalProps> = ({ visible, onClose, postId, mediaUrl, username, userAvatar, content_type, caption, onCommentAdded, onCommentDeleted }) => {
